...
namespace BKashPayments;

use function add_filter;
use function WC;
use const DOKAN_FILE;
use const DOKAN_PLUGIN_VERSION;

/**
 * Dokan tracker
 *
 * @since 2.4.11
 * @since 2.8.7 Using BKashPayments\Dependencies\Appsero\Insights for tracking
 */
class Tracker {
     ...
     * Insights class
     *
     * @var \BKashPayments\Dependencies\Appsero\Insights
     */
    ...
    public function appsero_init_tracker_dokan() {
        $client = new \BKashPayments\Dependencies\Appsero\Client( '559bcc0d-21b4-4b34-8317-3e072badf46d', 'Dokan Multivendor Marketplace', DOKAN_FILE );
        ...
        $this->insights->add_extra(
            function () {
                return [
                    ...
                    'plugin_version' => BKASH_PAYMENTS_PLUGIN_VERSION,
                ];
            }
        );
     ...
     * @param null|\BKashPayments\Dependencies\Appsero\Client $client
     *
     * @return \array
     * @since 3.0.15
     *
